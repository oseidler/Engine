...
{
	AddVertsForSphere3D(verts, m_position, m_radius, 16, 12, m_currentColor);
}
...
void DebugRenderSphere::AddVertsForXRayObject(std::vector<Vertex_PCU>& verts)
{
	...
	AddVertsForSphere3D(verts, m_position, m_radius, 16, 12, Rgba8(r, g, b, a));
}
...
void DebugRenderArrow::AddVertsForDebugObject(std::vector<Vertex_PCU>& verts)
{
	...
	AddVertsForCylinder3D(verts, m_start, m_end - iBasis * 0.10f, m_radius, 16, m_currentColor);
	
	AddVertsForCone3D(verts, m_end - iBasis * 0.10f, m_end, m_radius + 0.025f, 16, m_currentColor);
}
...
void DebugRenderArrow::AddVertsForXRayObject(std::vector<Vertex_PCU>& verts)
{
	...
	AddVertsForCylinder3D(verts, m_start, m_end - iBasis * 0.25f, m_radius, 16, Rgba8(r, g, b, a));

	AddVertsForCone3D(verts, m_end - iBasis * 0.25f, m_end, m_radius + 0.05f, 16, Rgba8(r, g, b, a));
}
...
{
	AddVertsForCylinder3D(verts, m_base, m_top, m_radius, 16, m_currentColor);
}
...
void DebugRenderCylinder::AddVertsForXRayObject(std::vector<Vertex_PCU>& verts)
{
	...
	AddVertsForCylinder3D(verts, m_base, m_top, m_radius, 16, Rgba8(r, g, b, a));
}
...
void DebugAddMessage(std::string& text, float duration, Rgba8 const& startColor, Rgba8 const& endColor)
{
